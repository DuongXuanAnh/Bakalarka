...
function DependencyPC() {
 ...
 const backToInputAttributes = () => {
  ...
  return (
    <div>
    <button className="addDependencyBtn" onClick={handleAddDependency}>{t('content-dependencies.addRelation')}</button>
    ...
    <Droppable droppableId="droppable">
      ...
      {dependencies.map((dep, depIndex) => (
        ...
        <button className='fillAllAttributesBtn' onClick={() => fillAllAttributes("left", depIndex)}>{t('global.fillAllAttributes')}</button>
          ...
          <select value="default" className="addAttrComboBox" onChange={(e) => handleAddAttribute(depIndex, "left", e.target.value)}>
            <option value="default" disabled>{t('content-dependencies.option_addAttribute')}</option>
        ...
        <button className='fillAllAttributesBtn' onClick={() => fillAllAttributes("right", depIndex)}>{t('global.fillAllAttributes')}</button>
        ...
        <button onClick={() => handleRemoveDependency(depIndex)} className="removeDependencyBtn">{t('content-dependencies.btn_removeDependency')}</button>
      </div>
    )}
    </Draggable>
  ))}
